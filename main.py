...
Allows you to choose a character, practice performing attacks,
block damage, apply special skills.
"""
...
def attack(char_name: str, char_class: str) -> str:
    ...
    return f'{char_name} урона не нанес'
...
def special(char_name: str, char_class: str) -> str:
    """Application of a special skill."""
    if char_class == 'warrior':
        return (f'{char_name} '
